...
var defaultNodeRenderer = function defaultNodeRenderer(_ref) {
  var depth = _ref.depth,
      ...
      rootFormat = _ref.rootFormat;

  return depth === 0 ? _react2.default.createElement(_ObjectRootLabel2.default, { name: name, data: data, format: rootFormat, expanded: expanded }) : _react2.default.createElement(_ObjectLabel2.default, { name: name, data: data, isNonenumerable: isNonenumerable });
};
...
ObjectInspector.propTypes = {
  ...
  rootFormat: _propTypes2.default.string,
